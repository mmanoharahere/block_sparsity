...
IMAGE_SIZE = LeNet_input.IMAGE_SIZE
...
def distorted_inputs():
  ...
  data_dir = os.path.join(DATA_DIR, 'LeNet-batches-bin')
  images, labels = LeNet_input.distorted_inputs(
...
def inputs(eval_data):
  ...
  images, labels = LeNet_input.inputs(
