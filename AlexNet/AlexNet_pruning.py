...
NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = AlexNet_input.NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN  # pylint: disable=line-too-long
NUM_EXAMPLES_PER_EPOCH_FOR_EVAL = AlexNet_input.NUM_EXAMPLES_PER_EPOCH_FOR_EVAL
BATCH_SIZE = 64
DATA_DIR = './tmp/AlexNet_data'
...
def distorted_inputs():
  ...
  data_dir = os.path.join(DATA_DIR, 'AlexNet-batches-bin')
  images, labels = AlexNet_input.distorted_inputs(
...
def inputs(eval_data):
  ...
  images, labels = AlexNet_input.inputs(
...
def inference(images):
  ...
  #   weights = _variable_with_weight_decay(
  #       'weights', shape=[1024, 192], stddev=0.04, wd=0.004)
